...
try:
    ...
    try:
        ...
        raise ImportError("ServiceExample_PageContext plugin requires the new architecture BaseLifecycleManager")


class ServiceExamplePageContextLifecycleManager(BaseLifecycleManager):
    """Lifecycle manager for ServiceExample_PageContext plugin using new architecture"""
    
    def __init__(self, plugins_base_dir: str = None):
        """Initialize the lifecycle manager"""
        # ServiceExample_PageContext plugin-specific data
        self.plugin_data = {
            ...
            "author": "BrainDrive",
            "compatibility": "1.0.0",
            "scope": "ServiceExample_PageContext",
            "bundle_method": "webpack",
            "bundle_location": "dist/remoteEntry.js",
            "is_local": False,
            "long_description": "A comprehensive educational example demonstrating how to use BrainDrive's PageContext Service Bridge. Shows page information retrieval, context change listening, and plugin state management patterns with extensive logging for learning purposes.",
            ...
            "permissions": ["storage.read", "storage.write", "pageContext.read"]
        }
        
        # ServiceExample_PageContext module definitions
        self.module_data = [
            {
                "name": "PageContextDisplay",
                "display_name": "PageContext Display",
                "description": "Displays current page context information with real-time updates",
                "icon": "Monitor",
                "category": "examples",
                "priority": 1,
                "props": {
                    "title": "PageContext Display",
                    "description": "Shows current page context information",
                    "config": {
                ...
                "config_fields": {
                    ...
                    "auto_refresh": {
                        "type": "boolean",
                        "description": "Enable automatic refresh of page context",
                        "default": True
                    }
                },
                "messages": {},
                ...
                "tags": ["pagecontext", "display", "example", "educational"]
            },
            {
                "name": "PageContextListener",
                "display_name": "PageContext Listener",
                "description": "Demonstrates listening for page context changes with history tracking",
                "icon": "Activity",
                "category": "examples",
                "priority": 2,
                "props": {
                    "title": "PageContext Listener",
                    "description": "Listens for and displays page context changes",
                    "config": {
                        "maxHistoryItems": 10,
                        "showTimestamps": True,
                        "enableLogging": True
                ...
                "config_fields": {
                    ...
                    "show_timestamps": {
                        "type": "boolean",
                        "description": "Show timestamps for context changes",
                        "default": True
                    },
                    "enable_logging": {
                        "type": "boolean",
                        "description": "Enable detailed logging for educational purposes",
                        "default": True
                    }
                },
                "messages": {},
                ...
                "tags": ["pagecontext", "listener", "example", "educational", "history"]
            }
        ]
    ...
    async def update_plugin(self, user_id: str, db: AsyncSession, new_version_manager: 'PageContextLifeCycleManager') -> Dict[str, Any]:
...
async def install_plugin(user_id: str, db: AsyncSession, plugins_base_dir: str = None) -> Dict[str, Any]:
    manager = ServiceExamplePageContextLifecycleManager(plugins_base_dir)
...
async def update_plugin(user_id: str, db: AsyncSession, new_version_manager: 'ServiceExamplePageContextLifecycleManager', plugins_base_dir: str = None) -> Dict[str, Any]:
    old_manager = ServiceExamplePageContextLifecycleManager(plugins_base_dir)
...
if __name__ == "__main__":
    ...
    async def main():
        print("ServiceExample_PageContext Plugin Lifecycle Manager - Test Mode")
        print("=" * 50)
        
        # Test manager initialization
        manager = ServiceExamplePageContextLifecycleManager()
